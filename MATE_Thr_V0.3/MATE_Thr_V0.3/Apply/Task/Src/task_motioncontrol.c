...
void HandleMode_data_handle()
{
   ...
   // PWMInfo.PWMout[v_wheel3_speed] =  -y_Speed -  x_Speed/abs(x_Speed)*(abs(x_Speed)-10) - YAWspeed + STOP_PWM_VALUE;
	...
	PWMInfo.PWMout[h_wheel2_speed] = z_Speed + STOP_PWM_VALUE_F;
    PWMInfo.PWMout[h_wheel3_speed] = z_Speed + STOP_PWM_VALUE_F;
    PWMInfo.PWMout[h_wheel4_speed] = z_Speed + STOP_PWM_VALUE_F;
...
void PWNOutput_limit(void)
{
	...
	if(PWMInfo.PWMout[h_wheel2_speed] < 1370)  PWMInfo.PWMout[h_wheel2_speed] = 1370;
    if(PWMInfo.PWMout[h_wheel2_speed] > 1670)  PWMInfo.PWMout[h_wheel2_speed] = 1670;

	if(PWMInfo.PWMout[h_wheel3_speed] < 1370)  PWMInfo.PWMout[h_wheel3_speed] = 1370;
    if(PWMInfo.PWMout[h_wheel3_speed] > 1670)  PWMInfo.PWMout[h_wheel3_speed] = 1670;

	if(PWMInfo.PWMout[h_wheel4_speed] < 1370)  PWMInfo.PWMout[h_wheel4_speed] = 1370;
    if(PWMInfo.PWMout[h_wheel4_speed] > 1670)  PWMInfo.PWMout[h_wheel4_speed] = 1670;
