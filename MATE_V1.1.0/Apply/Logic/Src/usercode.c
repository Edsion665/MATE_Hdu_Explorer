...
void UserLogic_Code(void)
{
	...
	thread5 = rt_thread_create("MODE_AUTO",AUTO_MODE,NULL,512,7,40);
	// if(RT_NULL != thread5)
	...
	thread7 = rt_thread_create("DepthControl",DepthControl,NULL,512,4,20);
	// if(RT_NULL != thread7)
	// 	printf("DepthControl create successful\r\n");
	...
	thread10 = rt_thread_create("pH_outcome",pH_outcome,NULL,512,7,20);
	// if(RT_NULL != thread7)
	// 	printf("TestThread create successful\r\n");
	thread11 = rt_thread_create("TestThread",TestThread,NULL,512,7,20);
	...
	rt_thread_startup(thread10);	//线程10 PH反馈
	rt_thread_startup(thread11);    //线程11 测试线程
